...
to get the code onto he server! However you do it, make note of how you copied,
...
same time on the same computer, there will be an error. So you'll need to pick a
port other than `4000`. If you want something unique for this lab you can use
`5000` + the number of the machine you're sitting in front of if in room B260,
and `6000` + that number if in room B270. Or experiment!
