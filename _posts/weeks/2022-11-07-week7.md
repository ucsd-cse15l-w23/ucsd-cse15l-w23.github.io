...
In particular, you'll write a script that gives a score to the functionality of
a student-submitted `ListExamples` file and class (see
...
```
$ bash grade-lists.sh https://github.com/some-username/some-repo-name
... messages about points ...
```

More details will be released close to the lab date – this is the general
structure we'll be working towards in lectures and for lab.
