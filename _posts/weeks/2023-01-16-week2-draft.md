...
Next, copy the files necessary to run your program to your account on `ieng6` and run it. 
...
**Note: To access the remote server's webpage you *must* be connect to the UCSD-PROTECTED Wi-Fi network.**
...
**Write down in notes** - Team up with another member of your group that you haven't worked with yet. Get their server URL and port number, and access their number server on ***your*** computer (**HINT**: You may want to share the URL and port number on your group's Google Doc). Take a screenshot of ***your*** computer running ***your partner’s*** server, which should show the current number and their name.
...
When you've implemented this (and even if you don't finish), push a copy of your new
