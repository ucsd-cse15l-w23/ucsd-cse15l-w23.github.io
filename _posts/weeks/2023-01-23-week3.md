...
**Write down in notes** – Symptoms and faulty inputs for each bug
...
- What are the values of the relevant arguments to those methods, and the values
of any relevant fields of the class?
- How do the values of any relevant fields of the class change by the time the query/request is done processing? If no values change, explain why. 

### Part 2

Choose two of the bugs _from different files_ above. This means that you should cover 2 bugs in total for your report. For each of them, show:
